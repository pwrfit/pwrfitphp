               ...
               <div class="container">
                  <div class="col-12" style="padding-top: 15px;">
                     <div class="section-title">
                        <h2 style="display: inline-block;margin-right: 68%;">Categorías</h2>
                        <a href="upload"><button type="button" class="btnf btn-dark" style="color:#fff;display:inline-block;"><i class="fa-solid fa-cloud-arrow-up"></i>&nbsp;&nbsp;Subir video</button></a>
                     </div>
                  </div>
                  <hr>
